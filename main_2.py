...
df = pd.read_csv("C:/Users/mkolwal/PycharmProjects/Air_bnb_/simplified_airbnb.csv")
...
if option == 'Home':
    ...
    with col2:
        image = Image.open("C:/Users/mkolwal/PycharmProjects/Air_bnb_/airbnb.png")
        st.image(image)
    st.write(
    ...
    st.write('## :red[Name]: Mayank Raj Kolwal')
    st.write('### :red[LinkedIn]: Mayank Raj Kolwal :link: [link](https://www.linkedin.com/in/mayank-raj-6066/)')
    st.write('### :red[github]: github.com/Mayankrajk? :link: [link](https://github.com/Mayankrajk?)')